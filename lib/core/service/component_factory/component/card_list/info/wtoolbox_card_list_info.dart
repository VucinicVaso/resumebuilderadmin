...
class WTCardListInfo extends WTCardList {
  ...
  /// item { icon, decorationIcon, assetImage, networkImage, memoryImage, svgImageMemory, svgImageString, svgImageNetwork, }
  Widget? leftWidget(Map? item) {
    ...
    // svgImageMemory, svgImageString, svgImageNetwork, svgImageAsset
    if(item['svgImageMemory'] != null || item['svgImageString'] != null
