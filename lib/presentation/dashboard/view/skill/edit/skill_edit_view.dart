...
import '../../../controller/skill/edit/skill_edit_controller.dart';

// ignore: must_be_immutable
class SkillEditView extends WTWView<SkillEditController> {

  SkillEditView({ super.key }) {
    setController(SkillEditController());
  }

  WTWUIComponent? createScaffold(SkillEditController? con) {
